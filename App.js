    ...
    return(
        <div className="header">
            <div className="logo-container">
                <img className="logo" src="https://www.logodesign.net/logo/smoking-burger-with-lettuce-3624ld.png?nwm=1&nws=1&industry=restaurant-food&sf=&txt_keyword=Allhttps://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660"/>
            </div>
...
const RestaurantCard=(props)=>{
    ...
    return(
        <div className="res-card" style={{backgroundColor:"#f0f0f0"}}>
            <img className="res-logo alt="res-logo src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+resData.data.cloudinaryImageId}/>
            {/* <h3>Meghana Foods</h3>
    ...
    return(
        <div className="body">
            ...
            <div className="res-container">
                 {/* <RestaurantCard resName="Meghana Foods" cuisine="Biryani North Indian,Asian"/>//1
